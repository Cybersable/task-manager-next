...
const linkStyle = tv({
  base: 'cursor-pointer focus:outline-none focus:underline font-medium text-sm rounded-lg px-2.5 py-1.5',
  variants: {
    schema: {
        link: 'text-blue-600 dark:text-blue-500 hover:text-blue-700',
